        ...
        <>
            ...
            <SecondaryLayout>
                <section className="block-primary">
                    ...
                    <Paragraph>
                        После запуска ЕСО (с января 2023г) существует новая схема заработка и распределние поинтов. Более подробно вы можете ознакомится <Link to='/seasons-eco'>ЗДЕСЬ</Link>
                    </Paragraph>
                    <ol className="block-primary__list-number">
                        <Li>
                            ...
                            Более подробно об ECO ID вы можете ознакомится <Link to='/eco-id'>ТУТ</Link>.
                        </Li>
                        <Li>
