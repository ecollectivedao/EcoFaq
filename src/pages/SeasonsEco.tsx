      ...
      <SecondaryLayout>
        <section className="block-primary">
          ...
          <Paragraph>Сезон включает в себя три месяца, по итогом которых производится снимок баланса.
            Каждый участник Eco дискорд имеет право на клеймение $ECO токены в конце каждого сезона, в соответствии с количеством поинтов на личном балансе на момент снимка.
          </Paragraph>
          ...
          <Paragraph>
            ...
            <A link='https://discord.com/login?redirect_to=%2Fchannels%2F768556386404794448%2F821228603622293515%2F1099053302945165454'>Клеймение $ECO токенов</A> стартовал 25 апреля 2023.
          </Paragraph>
